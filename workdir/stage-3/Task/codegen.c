...
int looptop = -1;
int breakloopstack[MAX_LOOP_DEPTH];
int continueloopstack[MAX_LOOP_DEPTH];
...
void pushstack(int breaklabel, int continuelabel)
{
    ...
    breakloopstack[looptop] = breaklabel;
    continueloopstack[looptop] = continuelabel;
}
