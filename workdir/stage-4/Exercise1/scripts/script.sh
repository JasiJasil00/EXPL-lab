...
cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise1/" || exit 1
...
if [[ ! -f "$INPUT_FILE" ]]; then
    cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise1/scripts"
    ./clean.sh
    cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise1/input files"
    echo "file names"
    ls
...
TRANSLATED_FILE="../workdir/stage-4/Exercise1/translatedFile.xsm"
