...
cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise2/" || exit 1
...
if [[ ! -f "$INPUT_FILE" ]]; then
    cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise2/scripts"
    ./clean.sh
    cd "/mnt/d/nitc curriculum/sem5/compiler design lab/workdir/stage-4/Exercise2/input files"
    echo "file names"
    ls
...
TRANSLATED_FILE="../workdir/stage-4/Exercise2/translatedFile.xsm"
